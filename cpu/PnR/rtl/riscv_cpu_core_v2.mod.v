// ============================================================================
// riscv_cpu_core.v - RISC-V 5-Stage Pipelined CPU Core (Synthesis Fixed)
// ============================================================================
...
module riscv_cpu_core (
    ...
    always @(posedge clk or posedge rst) begin
        if (rst) begin
            regwrite_id_ex <= 1'b0; alusrc_id_ex <= 1'b0; memread_id_ex <= 1'b0; 
            memwrite_id_ex <= 1'b0; memtoreg_id_ex <= 1'b0; branch_id_ex <= 1'b0; 
            jump_id_ex <= 1'b0; read_data1_id_ex <= 32'h0; read_data2_id_ex <= 32'h0; 
            imm_id_ex <= 32'h0; pc_id_ex <= 32'h0; rs1_id_ex <= 5'b0; rs2_id_ex <= 5'b0; 
            rd_id_ex <= 5'b0; funct3_id_ex <= 3'b0; funct7_id_ex <= 7'b0; 
    ...
    always @(posedge clk or posedge rst) begin
        if (rst) begin
            ...
            if (!stall_if) begin
                ...
                rd_ex_mem         <= rd_ex_mem;
                byte_size_ex_mem  <= byte_size_ex_mem;
    ...
    always @(posedge clk or posedge rst) begin
        if (rst) begin
            regwrite_mem_wb <= 1'b0; memtoreg_mem_wb <= 1'b0; jump_mem_wb <= 1'b0;
            ...
            if (lsu_result_valid && !stall_if) begin
                ...
                jump_mem_wb       <= 1'b0;
                alu_result_mem_wb <= alu_result_mem_wb; // Keep for safety
