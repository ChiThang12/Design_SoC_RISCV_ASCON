...
// ============================================================================
// icache_top — kết nối, cập nhật bit widths cho 8-word line
// ============================================================================
module icache_top #(
    ...
    // Internal signals — bit widths cập nhật
    wire [4:0]  tag_lookup_index;   // 5 bit
    wire [21:0] tag_lookup_tag;
    wire        tag_hit;
    wire        tag_update_valid;
    wire [4:0]  tag_update_index;   // 5 bit
    wire [21:0] tag_update_tag;
    wire        tag_flush_all;

    wire [4:0]  data_read_index;    // 5 bit
    wire [2:0]  data_read_offset;   // 3 bit
    wire [31:0] data_read_data;
    wire        data_write_enable;
    wire [4:0]  data_write_index;   // 5 bit
    wire [2:0]  data_write_offset;  // 3 bit
