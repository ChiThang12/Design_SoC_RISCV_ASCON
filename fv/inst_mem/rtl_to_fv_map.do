...
# Generated on: Fri Feb 13 19:33:35 +07 2026 (Fri Feb 13 12:33:35 UTC 2026)
...
set logfile fv/inst_mem/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/inst_mem -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/root/cadence/installs/DDIEXPORT23/GENUS231/tools.lnx86"
set CDN_SYNTH_ROOT      "/root/cadence/installs/DDIEXPORT23/GENUS231/tools.lnx86"
set env(CW_DIR) "/root/cadence/installs/DDIEXPORT23/GENUS231/tools.lnx86/lib/chipware"
set CW_DIR      "/root/cadence/installs/DDIEXPORT23/GENUS231/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /root/cadence/installs/DDIEXPORT23/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/root/cadence/installs/DDIEXPORT23/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/root/cadence/installs/DDIEXPORT23/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/root/cadence/installs/DDIEXPORT23/GENUS231/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/root/cadence/installs/DDIEXPORT23/GENUS231/tools.lnx86/lib/chipware/sim"
}
...
add_notranslate_modules -library -both RM_IHPSG13_2P_1024x32_c2_bm_bist
# ILM modules: 

add_search_path $absolute_libaries_path -library -both
read_library -liberty -both \
    /home/ducnm.23ce/Documents/SoC_RISCV/Design_SoC_RISCV_ASCON/libraries/lib/slow/RM_IHPSG13_2P_1024x32_c2_bm_bist_slow_1p08V_125C.lib \
    ...
    /home/ducnm.23ce/Documents/SoC_RISCV/Design_SoC_RISCV_ASCON/libraries/lib/typ/RM_IHPSG13_2P_1024x32_c2_bm_bist_typ_1p20V_25C.lib \
    ...
    /home/ducnm.23ce/Documents/SoC_RISCV/Design_SoC_RISCV_ASCON/libraries/lib/fast/RM_IHPSG13_2P_1024x32_c2_bm_bist_fast_1p32V_m55C.lib \
...
add_search_path $absolute_rtl_path -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k rtl/inst_mem.v
elaborate_design -golden -root {inst_mem} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/inst_mem/fv_map.v.gz
elaborate_design -revised -root {inst_mem}
...
set_analyze_option -mapping_file fv/inst_mem/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.inst_mem.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.inst_mem.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.inst_mem.rtl.fv_map.rpt
