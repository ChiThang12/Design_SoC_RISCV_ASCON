/* test_ascon_dma_coherent_nofence_sweep.c
 * Parameterized hardware-coherent ASCON DMA no-fence benchmark.
 * Set PAYLOAD_BYTES in a wrapper file, e.g. 256/512/1024. */
#include <stdint.h>
#include "ascon.h"
