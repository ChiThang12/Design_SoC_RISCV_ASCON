...
### 7.3 Bảng so sánh (điền sau khi chạy)

| Metric | SW (Python) | HW (100 MHz sim) |
|--------|------------|-----------------|
| Time (µs) | — | — |
| Throughput (MB/s) | — | — |
| Throughput (Mbps) | — | — |
...
```
[ ] 1. Tạo ascon/SW_check/ascon_process_pic.py
[ ] 2. Chạy python3 ascon_process_pic.py → kiểm tra CT/TAG in ra và file pic_test_vectors.hex
[ ] 3. Tạo ascon/tb_pic_encrypt.v (WR_FIFO_DEPTH=32, đọc pic_test_vectors.hex)
[ ] 4. Chạy ./workflow/urun_verilog.sh ascon/tb_pic_encrypt.v
[ ] 5. Kiểm tra log: [PASS] TAG + [PASS] CT
[ ] 6. Ghi hw_cycles từ log
[ ] 7. Điền bảng so sánh ở mục 7.3
[ ] 8. Báo cáo kết quả: correctness + throughput HW vs SW
```
