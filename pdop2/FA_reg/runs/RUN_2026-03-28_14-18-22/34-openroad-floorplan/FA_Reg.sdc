...
set_input_delay 1.6000 -clock [get_clocks {clk}] -add_delay [get_ports {VGND}]
set_input_delay 1.6000 -clock [get_clocks {clk}] -add_delay [get_ports {VPWR}]
...
set_output_delay 1.6000 -clock [get_clocks {clk}] -add_delay [get_ports {VGND}]
set_output_delay 1.6000 -clock [get_clocks {clk}] -add_delay [get_ports {VPWR}]
